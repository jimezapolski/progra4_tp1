...
namespace descripciones {
    
    type infoExtra = 
        | {type: "archivo", url: string}
        | {type: "campoInfo", texto: string}
        ...
        var tareasMasInfo = new Map<infoExtra, Tareas[]>();
        console.log("arranca vacio para cada tarea");
        console.log(tareasMasInfo);

        const asignatareasMasInfo = (mapa: Map<infoExtra, Tareas[]>, info: infoExtra, tareas: Tareas[]) => {
        ...
        const infoArchivo: infoExtra = { type: "archivo", url: "/file......" };
        ...
        const infoDescripcion: infoExtra = { type: "campoInfo", texto: "esto es mas informacion" };
        ...
        function ordenarTareasPorPrioridad(mapa: Map<infoExtra, Tareas[]>) {
