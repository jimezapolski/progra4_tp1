...
namespace validacionPersonas {
    ...
    function validacionPersonas<T>(resultado: ResultadoBusqueda<T>): string {
    ...
    const r1: ResultadoBusqueda<string> = { tipo: "exito", encontrado: "Jime" };
    console.log(validacionPersonas(r1));

    const r2: ResultadoBusqueda<string[]> = { tipo: "exito", encontrado: ["nombre", "apellido"]};
